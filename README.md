...
- **Drag to reorder window thumbnails**: drag the thumbnails in an app's window-preview popup to reorder them. The custom order is shared across every monitor's dock for the session.
